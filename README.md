...
This repository contains a collection of data analysis projects developed using **Power BI**, **SQL (BigQuery)**. The focus of these projects is to translate raw data into actionable business insights through rigorous ETL processes and advanced visualization.
...
* **Reporting:** LaTeX (documentation), Markdown.

---
*Note: Some project screenshots and data labels reflect the original Polish language version of the software.*
